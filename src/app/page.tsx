...
export default async function HomePage({
  ...
  return (
    <div className="bg-surface text-on-surface">
      ...
      {/* Dark Footer */}
      <footer className="w-full py-20 mt-20 bg-[#1c1b18] text-[#f7f6f3] flex flex-col items-center justify-center gap-12 text-center font-plus-jakarta border-t border-white/10">
        ...
        <div className="w-full max-w-6xl px-8 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex gap-6 text-[10px] font-bold uppercase tracking-widest text-white/50">
            <a className="hover:text-[#fe97b9] transition-colors" href="#">Privacidad</a>
            <a className="hover:text-[#fe97b9] transition-colors" href="#">Términos</a>
            <a className="hover:text-[#fe97b9] transition-colors" href="#">Envíos</a>
          </div>
