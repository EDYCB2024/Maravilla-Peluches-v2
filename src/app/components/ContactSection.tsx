  ...
  return (
    <section id="nosotros" className="px-8 py-20 max-w-7xl mx-auto scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8 bg-surface-container-low/50 p-8 rounded-[2.5rem] border border-surface-container">
          <div>
          ...
          <div className="space-y-4 pt-4 border-t border-surface-variant/10">
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 rounded-2xl bg-surface-container-lowest hover:bg-primary/5 border border-surface-container hover:border-primary/20 transition-all group"
            >
              <div className="w-12 h-12 rounded-full bg-green-500/10 text-green-600 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-surface-container-lowest border border-surface-container">
        ...
        <div className="lg:col-span-7 bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] shadow-[0_12px_40px_rgba(146,63,95,0.06)] border border-primary/10 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 bg-primary text-on-primary rounded-full font-bold shadow-lg hover:scale-[1.02] active:scale-95 transition-all text-xs uppercase tracking-widest disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isSending ? (
                <>
